...
public class SphericalGrid : MonoBehaviour
{
	...
	public void CreateNodes()
	{
		...
		for(int i = 0; i < gridPositions.Length; i++)
		{
			...
			Vector2 newPolar = CoordinateHelper.CartesianToPolar(newNode.worldPosition);
			newPolar.x += 180;
			newPolar.y += 180;
	...
	{
		Vector3 pos01 = CoordinateHelper.PolarToCartesian(polarPos01, planetRadius);
		Vector3 pos02 = CoordinateHelper.PolarToCartesian(polarPos02, planetRadius);
	...
	{	
		...
		Vector2 polarUVPoint = CoordinateHelper.CartesianToPolar(pos);
	...
	{	
		...
		// Convert world position to polar point and snap it to our grid
		Vector2 polarUVPoint = CoordinateHelper.CartesianToPolar(node.worldPosition);
